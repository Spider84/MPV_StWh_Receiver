...
#define TIMER0_SEED               (262 - ( (SYSTEM_CLOCK / BAUDRATE) / TIMER_PRESCALER ))
...
#else
    #define INITIAL_TIMER0_SEED       ( 256 - (( (SYSTEM_CLOCK / BAUDRATE) / TIMER_PRESCALER ) * 4/3) )
